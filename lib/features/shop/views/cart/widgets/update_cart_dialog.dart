...
Future<dynamic> showUpdateCartDialog(BuildContext context, {required int productID}) async {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () => ProductsController.instance.updateCart(productID: productID),
