      ...
      child: Column(
        children: [
          TRoundedContainer(
            ...
            child: Stack(
              children: [
                TRoundedImage(imageUrl: "assets/images/pexels-madebymath-90946-removebg-preview.png", applyImageRadius: true, backgroundColor: dark ? TColors.black : TColors.light, onPressed: () => Get.to(() => ProductDetailsScreen(productID: productID, name: name, price: price, availableQuantity: availableQuantity, imageProduct: image, productionDate: productionDate, expiryDate: expiryDate))),
                Positioned(
                  bottom: 12,
